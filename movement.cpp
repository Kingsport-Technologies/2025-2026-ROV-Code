...
void initialize_thrusters() {
    ...
    set_servo_pulsewidth(pi_num,horiz_front_left,1500);
    set_servo_pulsewidth(pi_num,horiz_front_right,1500);
    set_servo_pulsewidth(pi_num,horiz_back_left,1500);
    set_servo_pulsewidth(pi_num,horiz_back_right,1500);
    set_servo_pulsewidth(pi_num,vert_left,1500);
    set_servo_pulsewidth(pi_num,vert_right,1500);
}
...
void assign_to_thrusters() {
    ...
    if(!left_x && !left_y) {
        ...
        //set thruster pwm values
        set_servo_pulsewidth(pi_num,horiz_front_left,to_thruster_microseconds(a_value));
        set_servo_pulsewidth(pi_num,horiz_front_right,to_thruster_microseconds(b_value));
        set_servo_pulsewidth(pi_num,horiz_back_left,to_thruster_microseconds(b_value));
        set_servo_pulsewidth(pi_num,horiz_back_right,to_thruster_microseconds(a_value));
        ...
        //set thruster pwm values
        set_servo_pulsewidth(pi_num,horiz_front_left,to_thruster_microseconds(b_value));
        set_servo_pulsewidth(pi_num,horiz_front_right,to_thruster_microseconds(a_value));
        set_servo_pulsewidth(pi_num,horiz_back_left,to_thruster_microseconds(a_value));
        set_servo_pulsewidth(pi_num,horiz_back_right,to_thruster_microseconds(b_value));
...
int main() {
    pi_num = pigpio_start(); //connect to pigpio daemon
    initialize_thrusters();

    //create a loop for calibrate -> assign to thruster stuff
    //add code to get the joystick + rotary encoder inputs as json and assign to variables
